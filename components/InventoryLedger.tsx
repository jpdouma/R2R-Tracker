...
const InventoryLedger: React.FC<InventoryLedgerProps> = () => {
    ...
    const [editedData, setEditedData] = useState<InventoryLedgerItem | null>(null);
    ...
    const handleEdit = (item: InventoryLedgerItem) => {
        setEditingRowId(item.id);
        setEditedData(JSON.parse(JSON.stringify(item))); // Deep copy
    };
