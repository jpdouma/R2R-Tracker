...
import { KEY_METRICS, YEARS } from '../../constants';
import { useDataContext } from '../../contexts/DataContext';
import { CollapsibleSection } from '../ui/CollapsibleSection';
import { Accordion } from '../ui/Accordion';
import FinancialStatementViewer from './FinancialStatementViewer';

type InputSectionType = 'Assumptions' | 'OKRs' | 'Financial Statements';
...
const DataInput: React.FC<DataInputProps> = ({ onOpenScenarioPlanner }) => {
    ...
    const renderAssumptionsEditor = () => {
      ...
      return (
        <div className="space-y-2 max-h-[450px] overflow-y-auto pr-2">
            ...
            <Accordion title="Cost Of Goods Sold (forecast assumptions)" defaultOpen>
            ...
            <Accordion title="Forex & Exogenous Factors">
             ...
             <Accordion title="Channel Assumptions">
             ...
             <Accordion title="Company Overheads">
             ...
             <Accordion title="Webshop Funnel">
    ...
    const renderFinancialStatementsViewer = () => (
    ...
    return (
        <CollapsibleSection title="Assumptions & Budget" defaultOpen={false}>
            <div className="border-b border-brand-border mb-4">
                <nav className="-mb-px flex space-x-6" aria-label="Tabs">
                {(['Assumptions', 'OKRs', 'Financial Statements'] as InputSectionType[]).map((tab) => (
            ...
            {activeSection === 'Financial Statements' && renderFinancialStatementsViewer()}
        </CollapsibleSection>
    )
}
