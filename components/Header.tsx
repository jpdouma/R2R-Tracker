...
const validateImportData = (data: any): ExportData => {
    ...
    // FIX: Add 'plannedBudget' to required keys for export validation.
    ...
    // FIX: Add validation for plannedBudget structure.
...
const Header: React.FC = () => {
  const { 
    ...
    subPeriod, 
    setSubPeriod,
    // FIX: Destructure plannedBudget from context to use in export.
    plannedBudget,
    assumptionsData,
    okrs,
    pricingData,
  ...
  const handleExport = () => {
    try {
        const exportData: ExportData = {
            ...
            // FIX: Add plannedBudget to the exported data to match ExportData type.
            plannedBudget,
            assumptionsData,
            okrs,
            pricingData,
